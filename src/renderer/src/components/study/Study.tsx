        ...
        <div id="Study" className="mt-8 flex flex-col h-screen">
            <div className="flex-grow">
                ...
                <div className="flex justify-center items-center mt-20">
                    ...
                    <button onClick={handleStartStudy} className="bg-blue-500 hover:bg-blue-00 text-white font-bold py-2 px-4 rounded uppercase">Study Now</button>
                </div>
            </div>
            <div className="flex justify-center items-center mt-20 mb-20">
                <button className="bg-slate-800 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded uppercase text-sm">Options</button>
                <button className="bg-slate-800 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded uppercase text-sm">Custom Study</button>
                <button className="bg-slate-800 hover:bg-gray-700 text-white font-bold py-1 px-2 rounded uppercase text-sm">Description</button>
            </div>
        </div>
    );
}
